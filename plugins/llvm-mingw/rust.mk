...
$(PKG)_IGNORE   :=
# https://static.rust-lang.org/dist/2026-04-17/rustc-nightly-src.tar.xz.sha256
$(PKG)_VERSION  := nightly
$(PKG)_CHECKSUM := e23864cbd25298df55ee9abacd34d7b7330b867826a7b694af9e753d5cfd04a2
$(PKG)_SUBDIR   := $(PKG)c-$($(PKG)_VERSION)-src
$(PKG)_FILE     := $(PKG)c-$($(PKG)_VERSION)-src.tar.xz
$(PKG)_URL      := https://static.rust-lang.org/dist/2026-04-17/$($(PKG)_FILE)
$(PKG)_DEPS     := $(BUILD)~$(PKG)
...
define $(PKG)_BUILD
    ...
    (echo '[unstable]'; \
     ...
     echo 'LLVM_COMPILER_RT_LIB = "$(CLANG_RESOURCE_DIR)/lib/windows/libclang_rt.builtins-$(BUILD_ARCH_NAME).a"'; \
     echo '[target.$(TARGET_RUST)]'; \
