...
# Update mingw-w64 to b2b5e53
# https://github.com/mingw-w64/mingw-w64/tarball/b2b5e53e9d9be406e60ebc152a9cf161b87d4e12
# Keep-in sync with:
# https://github.com/mstorsjo/llvm-mingw/blob/$(llvm-mingw_VERSION)/build-mingw-w64.sh#L21
mingw-w64_VERSION  := b2b5e53
mingw-w64_CHECKSUM := 2701cb8a7745c52690ae86f174719ddf6b1a84d9ea75f6adcf733daea767373d
